			...
			<div class="sidebar-list">
				...
				<ul class="navbar-nav iq-main-menu" id="sidebar-menu">
					...
					<li class="nav-item"><a class="nav-link active"
						...
						</i> <span class="item-name">TesterDashboard</span>
					</a></li>
					
						<li><hr class="hr-horizontal"></li>
					<li class="nav-item"><a class="nav-link" href="listprojectoftester"
						 > <i class="icon"> <svg
					...
					<li class="nav-item"><a class="nav-link" href="buglist"
						 > <i class="icon"> <svg
									width="20" viewBox="0 0 24 24" fill="none"
									xmlns="http://www.w3.org/2000/svg" class="icon-20">
                                    <path opacity="0.4"
						...
						</i> <span class="item-name">Bugs</span>
					</a></li>
