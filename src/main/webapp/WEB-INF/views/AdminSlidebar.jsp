		...
		<div class="sidebar-body pt-0 data-scrollbar">
			<div class="sidebar-list">
				...
				<ul class="navbar-nav iq-main-menu" id="sidebar-menu">
					...
					<li class="nav-item"><a class="nav-link" href="newtaskuser"
						 target=""> <i class="icon"> <svg
									width="20" viewBox="0 0 24 24" fill="none"
									xmlns="http://www.w3.org/2000/svg" class="icon-20">
                                    <path opacity="0.4"
						...
						</i> <span class="item-name">Assign Task</span>
					</a></li>
						...
						</i> <span class="item-name">Add New User</span>
					</a></li>
					...
					<li class="nav-item"><a class="nav-link" href="listallprojectuser"
						> <i class="icon"> <svg
									width="20" viewBox="0 0 24 24" fill="none"
									xmlns="http://www.w3.org/2000/svg" class="icon-20">
                                    <path opacity="0.4"
