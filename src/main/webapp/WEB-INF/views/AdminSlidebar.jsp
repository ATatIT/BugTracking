			...
			<div class="sidebar-list">
				...
				<ul class="navbar-nav iq-main-menu" id="sidebar-menu">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="/admindashboard"> <i
					...
					<li class="nav-item"><a class="nav-link" href="listproject"
						 > <i class="icon"> <svg
									width="20" viewBox="0 0 24 24" fill="none"
									xmlns="http://www.w3.org/2000/svg" class="icon-20">
                                    <path opacity="0.4"
					...
					<li class="nav-item"><a class="nav-link" href="listprojectstatus"
						 > <i class="icon"> <svg
									width="20" viewBox="0 0 24 24" fill="none"
									xmlns="http://www.w3.org/2000/svg" class="icon-20">
                                    <path opacity="0.4"
						...
						</i> <span class="item-name">ListProjectStatus</span>
					</a></li>
					<li class="nav-item"><a class="nav-link" href="listprojectuser"
						> <i class="icon"> <svg
									width="20" viewBox="0 0 24 24" fill="none"
									xmlns="http://www.w3.org/2000/svg" class="icon-20">
                                    <path opacity="0.4"
						...
						</i> <span class="item-name">ListProjectUser</span>
					</a></li>
					
					<li class="nav-item"><a class="nav-link" href="listmodule"
						 > <i class="icon"> <svg
									width="20" viewBox="0 0 24 24" fill="none"
									xmlns="http://www.w3.org/2000/svg" class="icon-20">
                                    <path opacity="0.4"
						...
						</i> <span class="item-name">ListModule</span>
					</a></li>
					<li class="nav-item"><a class="nav-link" href="listtask"
						 > <i class="icon"> <svg
									width="20" viewBox="0 0 24 24" fill="none"
									xmlns="http://www.w3.org/2000/svg" class="icon-20">
                                    <path opacity="0.4"
						...
						</i> <span class="item-name">ListTask</span>
					</a></li>
					<li class="nav-item"><a class="nav-link" href="listtaskuser"
						 > <i class="icon"> <svg
									width="20" viewBox="0 0 24 24" fill="none"
									xmlns="http://www.w3.org/2000/svg" class="icon-20">
                                    <path opacity="0.4"
						...
						</i> <span class="item-name">ListTaskUser</span>
					</a></li>
					<li class="nav-item"><a class="nav-link" href="signup"
						...
						</i> <span class="item-name">Sign Up</span>
					</a></li>
				</ul>
				<!-- Sidebar Menu End -->
			</div>
