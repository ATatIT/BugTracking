					...
					<div class="row justify-content-center">
						<div class="col-md-6">
							<div
								...
								<div class="card-body" style="backgroungcolor: red;">
										...
										<div class="row">
											...
											<div class="col-lg-12">
												<div class="form-group">
													...
													<label for="email" class="form-label">OTP</label> <input
											...
											<div class="col-lg-12">
												<div class="form-group">
													...
													<label for="email" class="form-label">Re-type Password</label> <input
														type="password" class="form-control" id="confirmPassword" name="confirmPassword"
														aria-describedby="email" placeholder=" "> 
														<span style="color: red;"> ${confirmpassword}</span>
