								...
								<form class="row g-3" action="saveproject" method="post">
									<div class="col-md-6">
										<label class="form-label">Title</label> <input
											...
											name="projecttitle" value="${project.projecttitle}">
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<label class="form-label">Completion Date</label> <input
											type="date" class="form-control" id="validationCustom02"
											name="projectCompletionDate" value="${project.projectCompletionDate }">
									</div>
									...
									<div class="col-md-6">
										<label class="form-label">Status</label> <select class="form-select" name="projectStatusId">
											...
											<c:forEach items="${projectStatuList}" var="projectstatus">
												<option value="${projectstatus.statusId}" ${projectstatus.statusId == project.projectStatusId?"selected" : ""}>${projectstatus.status}</option>
											</c:forEach>
										</select>
									</div>
									<input type="hidden" name="projectId" value="${project.projectId}">
									<div class="col-12">
										<button class="btn btn-primary" type="submit">Update Project
											</button>
									</div>
								</form>
							</div>
