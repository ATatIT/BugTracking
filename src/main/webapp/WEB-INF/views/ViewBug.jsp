...
<body class="  ">
                        ...
                        <div class="mt-4">
                            <div class="card card-body d-flex justify-content-between">
                                <div class="header-title d-flex align-items-center">
                                    ...
                                    <c:if test="${role.roleId == 1 }">
                                        <a class="card-title"
                                            href="listtask?moduleId=${task.moduleId}"
                                            style="margin-left: auto;">Back</a>
                                    </c:if>
                                    <c:if test="${role.roleId == 2 }">
                                        <a class="card-title"
                                            href="listtaskofpm?moduleId=${task.moduleId}"
                                            style="margin-left: auto;">Back</a>
                                    </c:if>
                                    <c:if test="${role.roleId == 3 }">
                                        <a class="card-title"
                                            href="listtaskofdev?moduleId=${task.moduleId}"
                                            style="margin-left: auto;">Back</a>
                                    </c:if>
                                    <c:if test="${role.roleId == 4 }">
                                        <a class="card-title"
                                            href="listtaskoftester?moduleId=${task.moduleId}"
                                            style="margin-left: auto;">Back</a>
                                    </c:if>
                                        ...
                                        <div class="table-responsive">
                                            <div id="datatable_wrapper"
                                                ...
                                                <div class="table-responsive border-bottom my-3">
                                                    <table id="bug-table" class="table table-striped"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="even">
                                                                <td class="text-center " rowspan="14">${status.index+1}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-center" rowspan="6">Bug ID</td>
                                                            </tr>
                                                            <tr>
                                                                <td>BugId No.</td>
                                                                <td>#${b.bugId}</td>
                                                            ...
                                                            <tr>
                                                                <td class="text-center" rowspan="4">Project Detail</td>
                                                            </tr>
    ...
    function printBugDetails() {
        ...
        document.getElementById('print-link').addEventListener('click', printBugDetails);
    }
