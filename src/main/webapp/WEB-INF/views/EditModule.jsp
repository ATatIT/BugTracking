								...
								<form class="row g-3" action="savemodule" method="post">
									<div class="col-md-6">
										<label class="form-label">Title</label> <input
											...
											name="moduleName" value="${module.moduleName }">
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<textarea rows="4" class="form-control" name="description">${module.description }</textarea>
									...
									<div class="col-md-6">
										<label class="form-label">Status</label> <select class="form-select" name="status">
											...
											<c:forEach items="${projectStatusList}" var="projectstatus">
												<option value="${projectstatus.statusId}" ${projectstatus.statusId == module.status?"selected" : ""}>${projectstatus.status}</option>
											</c:forEach>
										</select>
									</div>
									...
									<div class="col-12">
										<button class="btn btn-primary" type="submit">Update Module
											</button>
									</div>
								</form>
							</div>
