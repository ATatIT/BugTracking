...
<title>BT| View Module Details</title>
								...
								<div
									...
									<div>
										<h5>
											...
											<c:if test="${module.status == 3 }">
												OnGoing
											</c:if>
											<c:if test="${module.status == 4 }">
												Complete
											</c:if>
										</h5>
										<br>
										<h5 class="">Project : ${project.projecttitle}</h5>
										<br>
										<h5 class="">Estimated Hours : ${module.estimatedHours}</h5>
										<h6 class="mb-0">Utillized Hours :
											${module.totalUtilizedHours}</h6>
									</div>
								</div>
								<div>
									<h5>Document URL</h5>
									<small><a href="${module.docURL}">${module.docURL}</a></small>
