...
public interface BugReportRepository extends JpaRepository<BugReportEntity, Integer> {
	...
	List<BugReportDto> findAllBugsWithDetailsByTaskIdAndStatus(@Param("taskId") Integer taskId,@Param("status") List<Integer> status);
	...
	BugReportEntity findByProjectIdAndModuleIdAndTaskIdAndStatus(Integer projectId,Integer moduleId ,Integer taskId,Integer status);
}
